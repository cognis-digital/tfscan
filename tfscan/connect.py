"""Native cognis-connect emit for tfscan — forward findings to any platform.

Maps tfscan's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    tfscan ... --format json | tfscan-emit --to stix
    tfscan-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
