"""TFSCAN core — Scan Terraform plans/configs for misconfigurations."""
...
RULES = [
    ("TFS-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("TFS-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("TFS-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
